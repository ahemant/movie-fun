...
public class MoviesBean {
    ...
    public MoviesBean(PlatformTransactionManager moviesPlatformTransactionManager) {
        this.transactionTemplate = new TransactionTemplate(moviesPlatformTransactionManager);
    }
